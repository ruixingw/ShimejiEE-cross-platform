...
public interface MascotPrefProvider {
    ...
    default boolean isMultiscreenAllowed() { return true; }
    ...
    default boolean isMultiscreenAllowed(String imageSet) { return isMultiscreenAllowed(); }
    default boolean isBehaviorEnabled(String imageSet, String behaviorName) { return true; }
}
